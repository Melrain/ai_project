    ...
    <div className=''>
      {products.length === 0 ? (
        ...
        <div className='flex flex-col w-full  gap-2'>
          <div className='w-full py-2 px-5 text-center bg-gradient-to-r from-purple-600 rounded-full via-mycolor-300 to-purple-800'>
            我的产品
          </div>
      ...
      <div className='w-full flex flex-col'>
        {products.length === 0 ? (
          ...
          <div className='w-full rounded-full flex justify-center items-center bg-mycolor-300 mt-10 py-2'>收益历史</div>
        )}
      </div>
    </div>
  );
