    ...
    <div className='relative  h-60 w-60 md:h-60 md:w-96'>
      {cards.map((card, index) => {
        return (
          <motion.div
            key={card.id}
            className='absolute dark:bg-black bg-black h-120 w-120 md:h-60 md:w-96 rounded-3xl p-4 shadow-xl border border-white/[0.1]  shadow-black/[0.1] dark:shadow-white/[0.05] flex flex-col justify-between'
            style={{
